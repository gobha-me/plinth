// Plinth shell — icon set. Thin strokes, tool-grade vocabulary.
const Icon = ({ name, size = 16, className = '', strokeWidth = 1.75, style }) => {
  ...
  switch (name) {
    case 'home':
      return <svg {...common}><path d="M3 12 12 3l9 9"/><path d="M5 10v10h14V10"/></svg>;
    case 'bell':
    ...
    case 'folder-open':
      return <svg {...common}><path d="M6 17 4 20V5a2 2 0 0 1 2-2h5l2 3h9a2 2 0 0 1 2 2v1"/><path d="M22 9 19 20H4l3-11h15z"/></svg>;
    case 'link':
    ...
    case 'gear':
      return <svg {...common}><circle cx="12" cy="12" r="3"/><path d="M19.4 15a1.65 1.65 0 0 0 .33 1.82l.06.06a2 2 0 0 1-2.83 2.83l-.06-.06a1.65 1.65 0 0 0-1.82-.33 1.65 1.65 0 0 0-1 1.51V21a2 2 0 0 1-4 0v-.09A1.65 1.65 0 0 0 9 19.4a1.65 1.65 0 0 0-1.82.33l-.06.06a2 2 0 0 1-2.83-2.83l.06-.06A1.65 1.65 0 0 0 4.6 15a1.65 1.65 0 0 0-1.51-1H3a2 2 0 0 1 0-4h.09A1.65 1.65 0 0 0 4.6 9a1.65 1.65 0 0 0-.33-1.82l-.06-.06a2 2 0 0 1 2.83-2.83l.06.06A1.65 1.65 0 0 0 9 4.6a1.65 1.65 0 0 0 1-1.51V3a2 2 0 0 1 4 0v.09A1.65 1.65 0 0 0 15 4.6a1.65 1.65 0 0 0 1.82-.33l.06-.06a2 2 0 0 1 2.83 2.83l-.06.06A1.65 1.65 0 0 0 19.4 9c.2.63.77 1.03 1.51 1.04H21a2 2 0 0 1 0 4h-.09a1.65 1.65 0 0 0-1.51 1z"/></svg>;
    case 'plus':
    ...
    case 'health':
      return <svg {...common}><path d="M8 2v4M16 2v4M3 10h18"/><rect x="3" y="4" width="18" height="18" rx="2"/><path d="M8 14h1l1.5 2L12 13l1.5 3 1.5-2h1"/></svg>;
    case 'wrench':
    ...
    case 'dots':
      return <svg {...common}><circle cx="12" cy="12" r="1.3" fill="currentColor"/><circle cx="19" cy="12" r="1.3" fill="currentColor"/><circle cx="5" cy="12" r="1.3" fill="currentColor"/></svg>;
    case 'alert':
    ...
    case 'pill':
      return <svg {...common}><rect x="2" y="9" width="20" height="6" rx="3" transform="rotate(-25 12 12)"/><line x1="8" y1="6" x2="13" y2="16"/></svg>;
    case 'play':
    ...
    case 'history':
      return <svg {...common}><path d="M3 12a9 9 0 1 0 3-6.7L3 8"/><polyline points="3 3 3 8 8 8"/><polyline points="12 7 12 12 15 14"/></svg>;
    case 'shuffle':
    ...
    case 'db':
      return <svg {...common}><ellipse cx="12" cy="5" rx="9" ry="3"/><path d="M3 5v6c0 1.66 4.03 3 9 3s9-1.34 9-3V5"/><path d="M3 11v6c0 1.66 4.03 3 9 3s9-1.34 9-3v-6"/></svg>;
    default:
